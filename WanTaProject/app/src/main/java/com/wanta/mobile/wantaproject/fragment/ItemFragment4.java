...
public class ItemFragment4 extends Fragment {
    ...
    private View view_itemfragment4;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view_itemfragment4 = inflater.inflate(R.layout.fragment_item_wardrobe_detail,container,false);
        initId();
        return view_itemfragment4;
    }
    @Override
    ...
    private void initId() {
        ...
        mWardrobe_detail_recycleview = (RecyclerView) view_itemfragment4.findViewById(R.id.wardrobe_detail_recycleview);
