 ...
 */
public class ItemFragment6 extends Fragment {

    private View view_itemfragment6;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view_itemfragment6 = inflater.inflate(R.layout.fragment_item_wardrobe_detail,container,false);
        initId();
        return view_itemfragment6;
    }
    @Override
    ...
    private void initId() {
        ...
        mWardrobe_detail_recycleview = (RecyclerView) view_itemfragment6.findViewById(R.id.wardrobe_detail_recycleview);
