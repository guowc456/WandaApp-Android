...
public class FrescoMaoBoLiDraweeView extends CustomSimpleDraweeView {

    public FrescoMaoBoLiDraweeView(Context context) {
        super(context);
    }

    public FrescoMaoBoLiDraweeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FrescoMaoBoLiDraweeView(Context context, AttributeSet attrs, int defStyle) {
