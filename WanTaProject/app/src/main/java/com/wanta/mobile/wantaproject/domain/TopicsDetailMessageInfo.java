 ...
 */
public class TopicsDetailMessageInfo {
    ...
    public TopicsDetailMessageInfo(int likenum, String favourstate) {
    ...
    public TopicsDetailMessageInfo(String picUrl, int picWidth, int picHeight) {
        this.picUrl = picUrl;
        this.picWidth = picWidth;
        this.picHeight = picHeight;
    }

    public TopicsDetailMessageInfo() {

    }

    public TopicsDetailMessageInfo(int icnfid, String title, String content, int likenum, int storenum,
    ...
    public TopicsDetailMessageInfo(int icnfid, String title, String content, int likenum, String username, String useravatar, String images) {
        this.icnfid = icnfid;
        this.title = title;
        this.content = content;
        this.likenum = likenum;
