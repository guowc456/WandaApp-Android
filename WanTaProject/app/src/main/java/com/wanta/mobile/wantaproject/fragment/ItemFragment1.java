...
public class ItemFragment1 extends Fragment {
    ...
    private View view_itemfragment1;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view_itemfragment1 = inflater.inflate(R.layout.fragment_item_wardrobe_detail,container,false);
        initId();
        return view_itemfragment1;
    }
    ...
    private void initId() {
        ...
        mWardrobe_detail_recycleview = (RecyclerView) view_itemfragment1.findViewById(R.id.wardrobe_detail_recycleview);
