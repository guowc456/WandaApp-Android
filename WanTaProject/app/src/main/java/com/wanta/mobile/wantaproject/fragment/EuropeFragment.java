...
public class EuropeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private String[] str = {
            "标题", "穿上毛衣，从上海一起回家，想想搭配一身凉快搭配，愉快的9天的时9天的时光快要过去了，呜呜呜呜，身高从上海一起回家，9天的时光快要过去了，呜呜呜呜，身高从上海一起回家，光快要过去了，呜呜呜呜，身高从上海一起回家，想想搭配一身凉快搭配，愉快的9天的",
            "作者"
    };
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView_europe = inflater.inflate(R.layout.fragment_europe,null);
        initId();
        return mView_europe;
    }
    private void initId() {
        europer_fresh = (SwipeRefreshLayout) mView_europe.findViewById(R.id.europer_fresh);
        europer_recycleview = (RecyclerView) mView_europe.findViewById(R.id.europer_recycleview);
        europer_fresh.setOnRefreshListener(this);
//        //改变加载显示的颜色
        europer_fresh.setColorSchemeResources(R.color.mostpopular_fresh_color);
        //放在子线程中是因为mostpopular_fresh还没有初始化完，加载的图标是不会显示的
        europer_fresh.post(new Runnable() {
            @Override
            public void run() {
                onRefresh();
            }
    ...
    private void init() {
        ...
        europer_recycleview.setLayoutManager(staggeredGridLayoutManager);
        mAdapter = new MostPopularFragmentAdapter(getActivity(),all_message);
        europer_recycleview.setAdapter(mAdapter);
        europer_recycleview.setOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
...
//                ToastUtil.showShort(getActivity(),"作者");
        ...
        mAdapter.setOnMostPopularItemHeartListener(new MostPopularFragmentAdapter.onMostPopularItemHeartListener() {
            ...
            public void onItemHeartClick(View view, final CustomSimpleDraweeView item_mostpopular_heart, final MostPopularInfo mostPopularInfo, final TextView textView) {
                final int position = europer_recycleview.getChildAdapterPosition(view);
    ...
    class MostPopularAsyTask extends AsyncTask<String,Integer,String> {
        ...
        protected void onPreExecute() {
            europer_fresh.setRefreshing(true);
        }
        ...
        protected void onPostExecute(String s) {
            europer_recycleview.scrollToPosition(0);
            europer_fresh.setRefreshing(false);
        }
    }
