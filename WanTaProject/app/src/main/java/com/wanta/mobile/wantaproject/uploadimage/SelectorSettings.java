...
public class SelectorSettings {
     ...
     * show wardrobe
     */
    public static final String SELECTOR_SHOW_WARDROBE = "selector_show_wardrobe";
    public static boolean isShowWardrobe = true;
    public static final String WARDROBE_ITEM_PATH = "/WARDROBE/WARDROBE";
