...
public class ItemFragment3 extends Fragment {
    ...
    private View view_itemfragment3;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view_itemfragment3 = inflater.inflate(R.layout.fragment_item_wardrobe_detail,container,false);
        initId();
        return view_itemfragment3;
    }
    ...
    private void initId() {
        ...
        mWardrobe_detail_recycleview = (RecyclerView) view_itemfragment3.findViewById(R.id.wardrobe_detail_recycleview);
